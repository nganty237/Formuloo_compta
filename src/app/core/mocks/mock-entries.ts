...
export const MOCK_ENTRIES: Ecriture[] = [
    {
        id: 'entry-1', entrepriseId: 'tenant-1', journalId: 'ACH', date: '2024-01-10', libelle: 'Achat de marchandises', valide: true,
        lignes: [
    ...
    {
        id: 'entry-2', entrepriseId: 'tenant-1', journalId: 'VTE', date: '2024-01-15', libelle: 'Vente de services', valide: true,
        lignes: [
    ...
    {
        id: 'entry-3', entrepriseId: 'tenant-1', journalId: 'BQ', date: '2024-01-18', libelle: 'Paiement fournisseur', valide: false,
        lignes: [
    ...
    {
        id: 'entry-4', entrepriseId: 'tenant-1', journalId: 'BQ', date: '2024-01-20', libelle: 'Encaissement client', valide: false,
        lignes: [
    ...
    {
        id: 'entry-5', entrepriseId: 'tenant-1', journalId: 'OD', date: '2024-01-31', libelle: 'Provision salaires', valide: false,
        lignes: [
